  ...
  return (
    <div>
      <div className="my-10 px-52">
        ...
        <h1 className='mt-5 px-24 pt-5 text-center text-4xl font-bold'><span className="text-blue-400">Senior Research Scientist</span></h1>
        <div className="my-5 flex flex-wrap items-start space-x-10">
            <div>
              <Image src='/persons/8.jpeg' alt='Nazish Zulfiqar' width={150} height={30} className="mb-2 rounded-md" />
              <p className="text-center">Nazish Zulfiqar</p>
            </div>
        </div>
      </div>
