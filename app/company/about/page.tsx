            ...
            <div className='text-justify'>
                ...
                <div className='flex-wrap'>
                    ...
                    <div className='flex items-center my-5'>
                        ...
                        <span className='text-md font-semibold text-gray-400'>Maintain time and temperature recordings data</span>
                    </div>
                    <div className='flex items-center my-5'>
                        <Target size={16} className='mr-2 text-blue-500' />
                        <span className='text-md font-semibold text-gray-400'>Enhance Brand Reputation</span>
                    </div>
                    <div className='flex items-center my-5'>
                        <Target size={16} className='mr-2 text-blue-500' />
                        <span className='text-md font-semibold text-gray-400'>Prevent unnecessary waste</span>    
                    </div>
                    <div className='flex items-center my-5'>
                        <Target size={16} className='mr-2 text-blue-500' />
                        <span className='text-md font-semibold text-gray-400'>Receive alerts (text, email, and/or audio/visual)</span>
                    </div>
                </div>
                <div>
                    ...
                    <div className='flex items-center my-5'>
                        ...
                        <span className='text-[25px] font-extrabold text-gray-300 mr-5'>
                        ...
                        <span className='text-[25px] font-extrabold text-gray-300'>
                            Operating Range
                            <p className='text-[16px] font-normal'>
